...
func (h *AdminHandler) UploadProblem(w http.ResponseWriter, r *http.Request) {
	...
	// Create challenge
	if err := h.repo.CreateChallenge(req.ID, req.Title, req.Description, req.Difficulty, req.Points, req.TestCases); err != nil {
...
func (h *AdminHandler) UploadTestCases(w http.ResponseWriter, r *http.Request) {
	...
	// Update test cases
	if err := h.repo.CreateChallenge(challenge.ID, challenge.Title, challenge.Description, challenge.Difficulty, challenge.Points, testCases); err != nil {
